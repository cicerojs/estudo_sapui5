sap.ui.define([
	"sap/ui/test/Opa5",
	"br/com/petrobras/pm/yspm/medidas/b/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("br.com.petrobras.pm.yspm_medidas_b.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "br.com.petrobras.pm.yspm_medidas_b",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "Centros/" + sObjectId;
